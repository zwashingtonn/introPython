...
a varible is like a closet for data values. 
...
# scenario and how would you write a variable to represent this value? A data type that can be used is boolen because it can ask someone if they are allergic to grass true/false.

# 9. In your own words, describe what a program is?
A program is a specific set of ordered operations. 
Describe the difference between a float and an integer. a float is a number with a decimal and a integer is any whole number 
