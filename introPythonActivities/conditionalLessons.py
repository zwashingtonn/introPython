...
"A paramater is a data holder while an arguement is the data."
...
def frige():
    foodinfrige = input ('food in frige') 
    if foodinfrige == 'cook for 5 minutes'
      print('ok food is cooking for 5 minutes')
    else: 
       print(' Sorry there is no food in the frige')
